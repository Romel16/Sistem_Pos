...
<script>
    ...
    $(document).ready(function() {
            ...
            ajax: {
                ...
                "dataSrc": function(respuesta) {
                    ...
                    for (let i = 0; i < respuesta.length; i++) {
                        TotalVenta = parseFloat(respuesta[i][5].replace('S./ ', '')) + parseFloat(
                            TotalVenta);
                ...
                api.column(groupColumn, {
                    ...
                    if (last !== group) {
                        ...
                        $(rows).eq(i).before(
                            ...
                            ' class="fas fa-trash fs-6 text-danger mx-1 btnEliminarVenta" style="cursor:pointer;"></i> ' +
                            '<i nroBoleta = ' + nroBoleta +
                            ' class="fas fa-edit fs-6 text-warning mx-2 btnEditarVenta" style="cursor:pointer;"></i> ' +
                            group +
                            '</td>' +
                            '</tr>'
                        );
        ...
        /*=================================
            EVENTO PARA FILTRAR FECHAS SEGUN RANGO DE FECHAS
        ====================================*/

        $('#btnFiltrar').on('click', function() {

            if ($("#ventas_desde").val() == '') {
                ventas_desde = '01/10/2022'
            } else {
                ventas_desde = $("#ventas_desde").val();
            }
            ...
            $('#tblDetalleVenta').Tabledit({
                ...
                buttons:{
                    edit: {
                        ...
                        html: '<i class="fas fa-edit text-primary fs-3></i>',
                        action: 'edit'
                    },
                    delete: {
                        class: 'btn btn-sm btn-default',
                        html: '<span class="glyphicon glyphicon-trash"></span>',
                        html: '<i class="far fa-trash-alt text-danger fs-3></i>',
                        action: 'delete'
                    }
                },
                //restoreButton: false,
