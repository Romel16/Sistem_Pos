...
<!-- Main Sidebar Container -->
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <a href="index.php" class="brand-link">
         ...
         <span class="brand-text font-weight-light">Mi Tienda Pos</span>
     </a>

    <div class="user-panel mt- pb-1 mb-1 d-flex">
        <div class="image">
         ...
         <nav class="mt-2">
             ...
             <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php endforeach; ?>
                 ...
                 <li class="nav-item">
                     <a style="cursor: pointer;" class="nav-link" href="http://localhost/OTROS/tienda?cerrar_sesion=1">
